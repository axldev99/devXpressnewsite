    <nav class="flex desk" style="position:sticky !important; top:0px;">
      <div id="link-wrap" class="link-wrap">
        ...
        <a href="#mesProjets" onclick="closeMenu()" class="navBar-Link disapear"><div class="intraLink" id="projects">Projets</div></a>
        <a href="#contactMe" onclick="closeMenu()" class="navBar-Link disapear"><div class="intraLink" id="contact">Contact</div></a>

      </div>
      <a onclick="openMenu()" class="icon navBar-Link navbarHamburger">
